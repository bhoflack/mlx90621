//% weight=100 color=#008080 icon="\uf043" block="MLX90621"
namespace mlx90621 {
    ...
    let mlx: MLX90261 | null = null
    let configreg: number | null = null
    ...
    export function init() {
        ...
        configreg = config_param[0] & 3 << 4

        mlx = new mlx90621.MLX90261(
            config[0x22],
            config[0x62],
            config[0xA2],
            config[0xC0],
